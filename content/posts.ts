...
export const posts: NewsPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      p(
        "🌍 Більше інформації та матеріали для участі є на офіційному сайті Всесвітньої молитви за Україну: prayforukraine.org.ua/ua",
      ...
      p(
        "Приєднуйтесь до Всесвітньої молитви за Україну! Моліться. Поширюйте. Запрошуйте інші церкви та вірян. Разом у вірі ми сильні! Разом у молитві ми незламні!",
  ...
  },
  {
    ...
    body: [
      ...
      p(
        "Тема з'їзду цього року є «Христоцентрична Місія»: Єдині в Христі, єдині в місії.",
  ...
  },
  {
    ...
    body: [
      ...
      p(
        "Часті питання: у таборі буде водна гірка, тому візьміть купальний костюм, рушник, змінний одяг та (за бажанням) сонцезахисний крем, а також головний убір і пляшку з водою. Наші вчителі й волонтери мають досвід роботи з дітьми. Обід і вечеря надаються табором, з урахуванням дитячих смаків; про алергії чи дієтичні обмеження, будь ласка, повідомте заздалегідь.",
      ...
      p(
        "Хочеш стати частиною команди волонтерів, у реєстрації, приготуванні їжі, роботі з дітьми чи фото- і відеозйомці? Не потрібно бути ідеальним. Головне це бажання служити! Пишіть або телефонуйте: 717-823-7814.",
  ...
  },
  {
    ...
    excerpt: p(
      ...
      "The church welcomed the new year together, with a word from the pastors, a prayer of blessing, and a shared holiday table."
    ),
    hero: {
  ...
  },
  {
    ...
    excerpt: p(
      ...
      "Our Charity Ukrainian Bake Sale was a great success. Funds were raised for a good cause, and the church was filled with warm fellowship."
    ),
    hero: {
  ...
  },
  {
    ...
    body: [
      ...
      p(
        "Дякуємо всім гостям, друзям та членам церкви, хто розділив це велике свято з нами! Попереду є нові горизонти з Богом.",
  ...
  },
  {
    ...
    body: [
      ...
      p(
        ...
        "Everyone is invited, including those who've long been part of our community, those who've only recently joined, and all our friends and guests. We'd love to see you there, to give thanks to God together for 20 years of our church's life and ministry!"
      ),
    ],
  },
  {
